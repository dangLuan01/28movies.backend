 ...
 <ul class="sidebar__nav">
    ...
    <!-- collapse -->
    <li class="sidebar__nav-item">
        <a class="sidebar__nav-link {{ Route::is('movie.product.index') || Route::is('movie.product.create') ? 'sidebar__nav-link--active' : '' }}" data-toggle="collapse" href="#collapseMenu" role="button" aria-expanded="false" aria-controls="collapseMenu">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
